import{$r as e,Ar as t,Cr as n,Ct as r,Dr as i,Er as a,Fr as o,Gr as s,Hi as c,Ir as l,Li as u,Nr as d,Or as f,Pr as p,Qr as ee,Tr as m,Vr as h,Xr as g,Yr as _,Zr as v,a as y,ai as te,bt as ne,ci as re,dr as b,fi as x,gi as S,gt as C,it as w,kr as T,lr as ie,mi as E,oi as D,qr as O,r as ae,s as k,si as oe,t as se}from"./c-ripple-DJgZqOyv.js";var ce=e=>{let t=b();return m(()=>{if(!e)return!1;let n=r.find(t=>t.name===e);if(n){let e=n.path;return e===`/`?t.fullPath===`/`:t.fullPath.startsWith(e)}return!1})},le=k.extend({name:`badge`,style:`
    .p-badge {
        display: inline-flex;
