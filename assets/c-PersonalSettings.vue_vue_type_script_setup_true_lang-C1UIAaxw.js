...
`,Dt={root:function(t){var s=t.props;return["p-tabs p-component",{"p-tabs-scrollable":s.scrollable}]}},It=k.extend({name:"tabs",style:_t,classes:Dt}),Et={name:"BaseTabs",extends:x,props:{value:{type:[String,Number],default:void 0},lazy:{type:Boolean,default:!1},scrollable:{type:Boolean,default:!1},showNavigators:{type:Boolean,default:!0},tabindex:{type:Number,default:0},selectOnFocus:{type:Boolean,default:!1}},style:It,provide:function(){return{$pcTabs:this,$parentInstance:this}}},Rt={name:"Tabs",extends:Et,inheritAttrs:!1,emits:["update:value"],data:function(){return{d_value:this.value}},watch:{value:function(t){this.d_value=t}},methods:{updateValue:function(t){this.d_value!==t&&(this.d_value=t,this.$emit("update:value",t))},isVertical:function(){return this.orientation==="vertical"}}};function Ft(e,t,s,n,i,a){return c(),f("div",d({class:e.cx("root")},e.ptmi("root")),[v(e.$slots,"default")],16)}Rt.render=Ft;const I=W({__name:"NumberField",props:at({id:{},name:{},label:{},placeholder:{},error:{},rules:{},inputProps:{},labelProps:{},minLength:{},maxLength:{},minValue:{},maxValue:{},compare:{},deleteButton:{type:Boolean}},{modelValue:{required:!0},modelModifiers:{}}),emits:["update:modelValue"],setup(e){const t=e,s=tt(e,"modelValue"),n=M("");function i(){s.value=parseFloat(n.value)||0}return H(s,a=>{n.value=a.toString()},{immediate:!0}),(a,o)=>(c(),w(et,d(t,{modelValue:n.value,"onUpdate:modelValue":o[0]||(o[0]=r=>n.value=r),"input-props":{...t.inputProps,type:"number"},onBlur:i}),null,16,["modelValue","input-props"]))}}),jt={class:"flex justify-end"},Ut={class:"flex flex-col gap-3 my-5"},Mt=W({__name:"PersonalSettings",setup(e){const t=ut(),s=nt(),n=st(),{personalSettings:i,isFetchLoading:a,isMutationLoading:o}=_(n),{firebaseUser:r}=_(s),p=M(!1),u=it(g());function g(){return i.value?i.value.clone():ot.create(r.value.uid)}async function L(){const y=r.value?.uid;if(!y)return;const l=u.clone();await n.updatePersonalSettings(y,l),p.value=!1}return H(p,()=>{Object.assign(u,g())},{immediate:!0}),rt(()=>{!i.value&&r.value&&n.fetchPersonalSettings(r.value.uid)}),(y,l)=>(c(),f($,null,[T("div",jt,[h(lt,{class:"border-none h-fit",variant:"neutral",icon:"pi pi-cog",loading:m(a),onClick:l[0]||(l[0]=b=>p.value=!0)},null,8,["loading"])]),h(dt,{isOpen:p.value,title:"Persoonlijke instellingen",description:"Nu kun je zelf bepalen hoe je het graag hebt.",cancelText:"Annuleren",confirmText:"Opslaan",confirmLoading:m(o),onConfirm:L,onCancel:l[6]||(l[6]=b=>p.value=!1)},{default:z(()=>[T("div",Ut,[m(t).name===m(D).TASKS?(c(),f($,{key:0},[h(I,{class:"w-full md:w-1/2 place-self-center",name:"tasks.amountOfDaysToShow",label:"Aantal dagen om te tonen in je takenlijst:",modelValue:u.tasks.amountOfDaysToShow,"onUpdate:modelValue":l[1]||(l[1]=b=>u.tasks.amountOfDaysToShow=b)},null,8,["modelValue"]),h(N,{class:"w-full md:w-1/2 place-self-center",name:"tasks.showDifficulty",label:"Toon moeilijkheidsgraad",modelValue:u.tasks.showDifficulty,"onUpdate:modelValue":l[2]||(l[2]=b=>u.tasks.showDifficulty=b)},null,8,["modelValue"])],64)):m(t).name===m(D).BOODSCHAPPEN?(c(),f($,{key:1},[h(I,{class:"w-full md:w-1/2 place-self-center",name:"groceries.amountOfDaysToShow",label:"Aantal dagen om te tonen in je boodschappenlijst:",modelValue:u.groceries.amountOfDaysToShow,"onUpdate:modelValue":l[3]||(l[3]=b=>u.groceries.amountOfDaysToShow=b)},null,8,["modelValue"]),h(N,{class:"w-full md:w-1/2 place-self-center",name:"groceries.showPromotions",label:"Toon promoties",modelValue:u.groceries.showPromotions,"onUpdate:modelValue":l[4]||(l[4]=b=>u.groceries.showPromotions=b)},null,8,["modelValue"]),h(N,{class:"w-full md:w-1/2 place-self-center",name:"groceries.showCategory",label:"Toon categorieën",modelValue:u.groceries.showCategory,"onUpdate:modelValue":l[5]||(l[5]=b=>u.groceries.showCategory=b)},null,8,["modelValue"])],64)):C("",!0)])]),_:1},8,["isOpen","confirmLoading"])],64))}});export{I as _,yt as a,ft as b,zt as c,Ct as d,Mt as e,Rt as s};
