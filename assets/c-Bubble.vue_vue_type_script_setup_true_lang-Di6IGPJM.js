import{z as C,y as J,d0 as X,ao as F,cA as G,cu as Y,ap as W,aU as I,b as a,c as u,r as f,j,t as k,aq as d,av as Z,cD as _,x as R,aI as tt,ak as nt,g as v,w as x,B as s,n as S,aJ as V,d as K,f as h,d1 as ot,h as et,G as rt,d2 as at,d3 as dt,bf as it,H as U,k as ut,c3 as lt,e as m,F as z,C as N}from"../bundle.js";const ct=t=>{const n=J();return C(()=>{if(!t)return!1;const o=X.find(e=>e.name===t);if(o){const e=o.path;return e==="/"?n.fullPath==="/":n.fullPath.startsWith(e)}return!1})};var st=`
    .p-badge {
        display: inline-flex;
