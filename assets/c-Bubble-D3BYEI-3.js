import{$r as e,Ar as t,At as n,Cr as r,Dr as i,Er as a,Fr as o,Gr as s,Hi as c,Ir as l,Li as u,Mt as d,Nr as f,Or as p,Ot as ee,Pr as te,Qr as ne,Tr as m,Vr as h,Xr as g,Yr as _,Zr as v,a as y,ai as re,bt as b,ci as x,fi as ie,gi as S,gt as C,it as w,kr as T,mi as E,oi as D,qr as O,r as ae,s as k,si as oe,t as se}from"./c-ripple-Drmeh0Td.js";var ce=e=>{let t=d();return m(()=>{if(!e)return!1;let n=ee.find(t=>t.name===e);if(n){let e=n.path;return e===`/`?t.fullPath===`/`:t.fullPath.startsWith(e)}return!1})},le=k.extend({name:`badge`,style:`
    .p-badge {
        display: inline-flex;
...
`,classes:{root:function(e){var t=e.props;return[`p-tag p-component`,{"p-tag-info":t.severity===`info`,"p-tag-success":t.severity===`success`,"p-tag-warn":t.severity===`warn`,"p-tag-danger":t.severity===`danger`,"p-tag-secondary":t.severity===`secondary`,"p-tag-contrast":t.severity===`contrast`,"p-tag-rounded":t.rounded}]},icon:`p-tag-icon`,label:`p-tag-label`}}),Te={name:`BaseTag`,extends:y,props:{value:null,severity:null,rounded:Boolean,icon:String},style:we,provide:function(){return{$pcTag:this,$parentInstance:this}}};function Z(e){"@babel/helpers - typeof";return Z=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Z(e)}function Ee(e,t,n){return(t=De(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function De(e){var t=Oe(e,`string`);return Z(t)==`symbol`?t:t+``}function Oe(e,t){if(Z(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t);if(Z(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var Q={name:`Tag`,extends:Te,inheritAttrs:!1,computed:{dataP:function(){return w(Ee({rounded:this.rounded},this.severity,this.severity))}}},ke=[`data-p`];function Ae(t,n,r,o,s,l){return O(),T(`span`,h({class:t.cx(`root`),"data-p":l.dataP},t.ptmi(`root`)),[t.$slots.icon?(O(),i(e(t.$slots.icon),h({key:0,class:t.cx(`icon`)},t.ptm(`icon`)),null,16,[`class`])):t.icon?(O(),T(`span`,h({key:1,class:[t.cx(`icon`),t.icon]},t.ptm(`icon`)),null,16)):p(``,!0),t.value!=null||t.$slots.default?g(t.$slots,`default`,{key:2},function(){return[a(`span`,h({class:t.cx(`label`)},t.ptm(`label`)),c(t.value),17)]}):p(``,!0)],16,ke)}Q.render=Ae;var je={key:1,class:`flex flex-col`},Me={class:`flex justify-between`},Ne={class:`xl:flex`},Pe={key:0,class:`flex flex-wrap gap-x-2`},$=[`src`],Fe=[`src`],Ie={key:0,class:`ms-2 mt-2 pi pi-external-link`},Le=[`href`],Re={key:0,class:`ms-2 mt-2 pi pi-external-link`},ze={key:3,class:`flex flex-wrap gap-2`},Be={key:1,class:`flex gap-2`},Ve=[`src`],He=[`src`],Ue={key:0,class:`xl:mt-2`},We=o({__name:`Bubble`,props:{title:{},subTitle:{},tags:{},url:{},route:{},withLinkIcon:{type:Boolean},description:{},avatar:{},avatarRoute:{},loading:{type:Boolean},clickable:{type:Boolean},isCollapsed:{type:Boolean},titleProps:{},titleWrapperProps:{},subTitleProps:{},descriptionProps:{},avatarProps:{}},emits:[`click`],setup(e,{emit:t}){let n=e,o=t,s=X(Y).greaterOrEqual(`md`),l=()=>{n.clickable&&o(`click`)};return(t,n)=>{let o=v(`RouterLink`);return O(),T(`div`,{class:u([`background-gray-light rounded-secondary p-5`,{"md:p-10":!e.isCollapsed,"hover:bg-opacity-30":!!e.url,"animate-pulse":!!e.loading,"cursor-pointer":!!e.clickable&&!!e.isCollapsed}])},[a(`div`,{class:u([`group/bubble flex justify-between`,{"cursor-pointer":!!e.clickable&&!e.isCollapsed,"w-full":t.$slots.fullControl}]),onClick:l},[t.$slots.fullControl?g(t.$slots,`fullControl`,{key:0}):(O(),T(`div`,je,[a(`div`,Me,[a(`div`,Ne,[e.url||e.route?.name||e.clickable?(O(),T(`div`,Pe,[e.avatar?(O(),T(r,{key:0},[e.avatarRoute?.name?(O(),i(o,{key:0,to:e.avatarRoute},{default:D(()=>[a(`img`,h({class:`rounded-full h-12 w-12 aspect-square object-cover`},e.avatarProps,{src:e.avatar}),null,16,$)]),_:1},8,[`to`])):(O(),T(`img`,h({key:1,class:`rounded-full h-12 w-12 aspect-square object-cover`},e.avatarProps,{src:e.avatar}),null,16,Fe))],64)):p(``,!0),e.route?.name?(O(),i(o,{key:1,class:u([`text-2xl font-bold mb-2`,S(s)?`!no-underline group-hover/bubble:!underline`:`!underline group-hover/bubble:!no-underline`]),to:e.route},{default:D(()=>[a(`h2`,h({class:`flex flex-nowrap`},e.titleProps),[f(c(e.title)+` `,1),e.withLinkIcon?(O(),T(`i`,Ie)):p(``,!0)],16)]),_:1},8,[`class`,`to`])):(O(),T(`a`,{key:2,class:u([`text-2xl font-bold mb-2`,S(s)?`!no-underline group-hover/bubble:!underline`:`!underline group-hover/bubble:!no-underline`]),href:e.url},[a(`h2`,h({class:`flex flex-nowrap`},e.titleProps),[f(c(e.title)+` `,1),e.withLinkIcon?(O(),T(`i`,Re)):p(``,!0)],16)],10,Le)),e.tags?(O(),T(`div`,ze,[(O(!0),T(r,null,_(e.tags,e=>(O(),i(S(Q),{class:`h-fit p-2`,value:e.value,severity:e.severity,rounded:e.rounded!==!1,icon:e.icon,pt:e.pt},null,8,[`value`,`severity`,`rounded`,`icon`,`pt`]))),256))])):p(``,!0)])):e.title?(O(),T(`div`,Be,[e.avatar?(O(),T(r,{key:0},[e.avatarRoute?.name?(O(),i(o,{key:0,to:e.avatarRoute},{default:D(()=>[a(`img`,h({class:`rounded-full h-12 w-12 aspect-square object-cover`},e.avatarProps,{src:e.avatar}),null,16,Ve)]),_:1},8,[`to`])):(O(),T(`img`,h({key:1,class:`rounded-full h-12 w-12 aspect-square object-cover`},e.avatarProps,{src:e.avatar}),null,16,He))],64)):p(``,!0),a(`div`,h({class:`flex flex-col`},e.titleWrapperProps),[a(`h2`,h({class:`text-2xl font-bold mb-2 xl:whitespace-nowrap`},e.titleProps),[f(c(e.title)+` `,1),e.tags?(O(!0),T(r,{key:0},_(e.tags,e=>(O(),i(S(Q),{class:`ms-2`,value:e.value,severity:e.severity,rounded:e.rounded!==!1,icon:e.icon,pt:e.pt},null,8,[`value`,`severity`,`rounded`,`icon`,`pt`]))),256)):p(``,!0)],16),g(t.$slots,`underTitle`)],16)])):p(``,!0),e.subTitle?(O(),T(`p`,h({key:2,class:`text-sm text-neutral-300 mt-2 mb-2 xl:ms-2 xl:mt-2 xl:whitespace-nowrap`},e.subTitleProps),c(e.subTitle),17)):p(``,!0)])]),e.description&&!e.isCollapsed?(O(),T(`div`,Ue,[(O(!0),T(r,null,_(Array.isArray(e.description)?e.description:[e.description],t=>(O(),T(`p`,h({class:`text-neutral-400 mb-2`},{ref_for:!0},e.descriptionProps),c(t),17))),256))])):p(``,!0)])),g(t.$slots,`right`)],2),e.isCollapsed?p(``,!0):g(t.$slots,`default`,{key:0})],2)}}});export{ye as a,X as i,Q as n,W as o,Y as r,M as s,We as t};